...
$config['um_default_country']='IN';

//email settings
$config['um_email_from']='noreply@prance.in';
$config['um_email_from_name']='Rahul Phate Innovation';
$config['um_email_activate_subject']='Activate your account';
$config['um_email_reset_subject']='Did you request a password reset?';

/*
image processing
*/
$config['um_img_dp_path']='assets/dps/';
$config['um_img_allowed_types']='gif|jpg|png';
$config['um_img_max_size']=2000;
$config['um_img_max_width']=2000;
$config['um_img_max_height']=2000;

$config['um_img_dp_thumb_w']=150;
$config['um_img_dp_thumb_h']=150;
...
$config['um_register_rules']=array(
               array(
                     'field'   => 'username', 
                     'label'   => 'Username', 
                     'rules'   => 'trim|required|is_unique[users.username]|min_length[5]|max_length[20]|xss_clean'
                  ),
               array(
                     'field'   => 'password', 
                     'label'   => 'Password', 
